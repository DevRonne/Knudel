...
export const metadata: Metadata = {
  title: "Impressum | Knudel Haustechnik",
  description: "Impressum und rechtliche Informationen zu Knudel Haustechnik.",
};
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p>
              ...
              <em>[USt-IdNr. hier eintragen]</em>
            </p>

            <h2>Berufsbezeichnung und berufsrechtliche Regelungen</h2>
            <p>
              Berufsbezeichnung: Installateur und Heizungsbauer<br />
            ...
            <p>
              ...
              <em>[Versicherung hier eintragen]</em>
            </p>
            <p>
