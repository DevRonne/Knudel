...
export const metadata: Metadata = {
  title: "Datenschutz | Knudel Haustechnik",
  description: "Datenschutzerklärung von Knudel Haustechnik.",
};
      ...
      <div className="container-custom">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p>
              Telefon: 05731 - 28 226<br />
              E-Mail: info@knudel-haustechnik.de
            </p>
            <p>
            ...
            <h3>Terminbuchung über Cal.com</h3>
            <p>
              Für die Online-Terminbuchung nutzen wir den Dienst Cal.com. 
              Wenn Sie einen Termin buchen, werden Ihre Daten (Name, E-Mail, 
              ggf. Telefonnummer) von Cal.com verarbeitet und an uns 
              weitergegeben.
            </p>
            <p>
              Details zur Datenverarbeitung durch Cal.com finden Sie unter:{" "}
              <a
            ...
            <h2>5. Ihre Rechte</h2>
            <p>
              Sie haben folgende Rechte bezüglich Ihrer bei uns gespeicherten 
